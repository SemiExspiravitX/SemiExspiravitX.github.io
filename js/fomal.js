...
$.ajax({
  ...
  data: {
    key: 'RFABZ-CXZKV-T6SP7-5EXS6-7FG72-HJBMG',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(104.07275, 30.57899, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("09/07/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Mirach🍉 %c 你正在访问Mirach🍉の小小窝窝",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("09/07/2023 00:00:00");
